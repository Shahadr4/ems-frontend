...
export default function EditDepartment() {
    ...
    useEffect(() => {
        const fetchDepartment = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`https://employee-frontend-it9y.vercel.app/api/department/${id}`, {
                    headers: {
    ...
    try {
        const response = await axios.put(`https://employee-frontend-it9y.vercel.app/api/department/${id}`, department, {
            headers: {
